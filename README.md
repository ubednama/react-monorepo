...
### Applications (`apps/`)
- **[Todo App](./apps/todo-app)**: A feature-rich Todo application built with React and Vite. [Live Demo](https://todo-app-mu-rouge.vercel.app/)
...
- **[Positivus](./landing-pages/positivus)**: A digital marketing agency landing page built with React and Vite. [Live Demo](https://positivus-ebon-one.vercel.app/)
- **[Refokus](./landing-pages/refokus)**: A creative agency landing page built with React and Vite. [Live Demo](https://refokus-rouge.vercel.app/)
