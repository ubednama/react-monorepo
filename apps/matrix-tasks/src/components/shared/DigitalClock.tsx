...
const DigitalClock = () => {
  ...
  return (
    <motion.div
      className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-linear-to-br from-slate-100/80 to-slate-200/80 dark:from-slate-800/80 dark:to-slate-900/80 border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-sm shadow-sm"
