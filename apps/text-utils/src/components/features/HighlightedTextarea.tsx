    ...
    return (
      <div className="relative">
        ...
        <Textarea
          ...
          className={cn(
            "bg-transparent resize-none relative z-10 min-h-[inherit] border-0 focus-visible:ring-0 focus-visible:ring-offset-0 px-0 py-0",
            "text-base leading-relaxed font-mono overflow-y-auto",
            "bg-transparent", // Ensure transparent background so highlight shows
            className
          )}
        />
      </div>
